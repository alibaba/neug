 ...
 * extension (i.e., not portable). This method is safe if your compiler supports
 ...
 * code on targets depending on alignment. In some circumstances, it's the only
 * known way to get the most performance (i.e. GCC + ARMv6) See
