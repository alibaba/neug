...
size_t ZSTD_noCompressLiterals(void* dst, size_t dstCapacity, const void* src,
  ...
  DEBUGLOG(5, "Raw literals: %u -> %u", (U32) srcSize,
           (U32) (srcSize + flSize));
...
size_t ZSTD_compressRleLiteralsBlock(void* dst, size_t dstCapacity,
  ...
  (void) dstCapacity; /* dstCapacity already guaranteed to be >=4, hence large
                         enough */
...
#define COMPRESS_LITERALS_SIZE_MIN 63
    ...
    cLitSize =
        singleStream
            ? HUF_compress1X_repeat(
                  ...
                  HUF_SYMBOLVALUE_MAX, HUF_TABLELOG_DEFAULT, entropyWorkspace,
                  entropyWorkspaceSize, (HUF_CElt*) nextHuf->CTable, &repeat,
                  preferRepeat, bmi2)
  ...
  DEBUGLOG(5, "Compressed literals: %u -> %u", (U32) srcSize,
           (U32) (lhSize + cLitSize));
