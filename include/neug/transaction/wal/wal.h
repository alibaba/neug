...
struct InsertVertexRedo {
  label_t label;
  columnar::Value oid;
  std::vector<columnar::Value> props;

  static void Serialize(InArchive& arc, label_t label,
                        const columnar::Value& oid,
...
struct InsertEdgeRedo {
  ...
  columnar::Value dst;
  label_t edge_label;
  std::vector<columnar::Value> properties;

  static void Serialize(InArchive& arc, label_t src_label,
                        const columnar::Value& src, label_t dst_label,
                        const columnar::Value& dst, label_t edge_label,
...
struct UpdateVertexPropRedo {
  ...
  static void Serialize(InArchive& arc, label_t label,
                        const columnar::Value& oid, int prop_id,
