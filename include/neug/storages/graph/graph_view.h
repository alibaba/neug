...
class VertexTableView {
 public:
  ...
  bool get_lid(const columnar::Value& oid, vid_t& lid, timestamp_t ts) const;
  vid_t LidNum() const;
  bool IsValidLid(vid_t lid, timestamp_t ts) const;
  columnar::Value GetOid(vid_t lid, timestamp_t ts) const;
  ...
  bool AddVertex(const columnar::Value& id,
                 const std::vector<columnar::Value>& props, vid_t& ret,
...
class GraphView {
 public:
  ...
  inline bool get_lid(label_t label, const columnar::Value& oid, vid_t& lid,
  ...
  columnar::Value GetOid(label_t label, vid_t lid, timestamp_t ts) const;
