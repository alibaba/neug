...
class PropertyGraph {
 public:
   ...
   */
  Status DeleteVertex(label_t v_label, const columnar::Value& oid,
                      timestamp_t ts);
  ...
  bool get_lid(label_t label, const columnar::Value& oid, vid_t& lid,
  ...
  Status UpdateEdgeProperty(label_t src_label, vid_t src_lid, label_t dst_label,
                            ...
                            const columnar::Value& new_prop, timestamp_t ts);
