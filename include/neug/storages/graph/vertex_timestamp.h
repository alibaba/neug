...
#ifndef INCLUDE_NEUG_STORAGES_GRAPH_VERTEX_TIMESTAMP_H_
#define INCLUDE_NEUG_STORAGES_GRAPH_VERTEX_TIMESTAMP_H_
...
#endif  // INCLUDE_NEUG_STORAGES_GRAPH_VERTEX_TIMESTAMP_H_