...
class IVertexColumn : public IColumn {
 public:
  IVertexColumn() : type_(DataType(DataTypeId::kVertex)) {}
  virtual ~IVertexColumn() = default;

  ColumnKind column_type() const override { return ColumnKind::kVertex; }
...
class IVertexColumnBuilder : public IColumnBuilder {
 public:
...
class MLVertexColumnBuilderOpt : public IVertexColumnBuilder {
 public:
  ...
  __attribute__((always_inline)) std::shared_ptr<IColumn> finish() override {
