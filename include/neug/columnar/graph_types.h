...
template <>
struct hash<neug::columnar::VertexRecord> {
  ...
  size_t operator()(const neug::columnar::VertexRecord& record) const {
    std::size_t seed = 0;
  ...
  std::size_t operator()(
      const std::pair<neug::columnar::VertexRecord,
                      neug::columnar::VertexRecord>& p) const {
    std::size_t seed = 0;
...
template <>
struct hash<neug::columnar::LabelTriplet> {
  size_t operator()(const neug::columnar::LabelTriplet& lt) const {
    size_t seed = 0;
