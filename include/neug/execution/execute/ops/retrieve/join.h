...
#ifndef INCLUDE_NEUG_EXECUTION_EXECUTE_OPS_RETRIEVE_JOIN_H_
#define INCLUDE_NEUG_EXECUTION_EXECUTE_OPS_RETRIEVE_JOIN_H_
...
#endif  // INCLUDE_NEUG_EXECUTION_EXECUTE_OPS_RETRIEVE_JOIN_H_
