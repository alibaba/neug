...
class SDSLEdgeColumn : public IEdgeColumn {
 ...
 private:
  ...
  neug::vector<std::tuple<vid_t, vid_t, const void*>> edges_;
};
...
class MSEdgeColumn : public IEdgeColumn {
 public:
  ...
  const neug::vector<std::tuple<vid_t, vid_t, const void*>>& seg_edges(
      size_t idx) const {
 ...
 private:
  ...
  neug::vector<std::tuple<int, Direction,
                          neug::vector<std::tuple<vid_t, vid_t, const void*>>>>
      edges_;
  size_t total_size_;
};
...
class MSEdgeColumnBuilder : public IContextColumnBuilder {
 ...
 private:
  ...
  Direction cur_dir_;
  neug::vector<std::tuple<vid_t, vid_t, const void*>> cur_edges_;
};
...
class BDSLEdgeColumn : public IEdgeColumn {
 ...
 private:
  ...
  LabelTriplet label_;
  neug::vector<std::tuple<vid_t, vid_t, const void*, Direction>> edges_;
  bool is_optional_;
};
...
class SDMLEdgeColumn : public IEdgeColumn {
 ...
 private:
  ...
  std::vector<LabelTriplet> labels_;
  neug::vector<std::tuple<int, vid_t, vid_t, const void*>> edges_;
  bool is_optional_;
};
...
class BDMLEdgeColumn : public IEdgeColumn {
 ...
 private:
  ...
  std::vector<LabelTriplet> labels_;
  neug::vector<std::tuple<int, vid_t, vid_t, const void*, Direction>> edges_;
  bool is_optional_;
};
