...
TEST_F(JsonLoadFunctionTest, TestExecFuncJsonArray) {
    ...
    auto arrow_col0 = std::dynamic_pointer_cast<gs::runtime::ArrowArrayContextColumn>(col0);
    auto arrow_col1 = std::dynamic_pointer_cast<gs::runtime::ArrowArrayContextColumn>(col1);
    auto arrow_col2 = std::dynamic_pointer_cast<gs::runtime::ArrowArrayContextColumn>(col2);
    auto arrow_col3 = std::dynamic_pointer_cast<gs::runtime::ArrowArrayContextColumn>(col3);
    auto arrow_col4 = std::dynamic_pointer_cast<gs::runtime::ArrowArrayContextColumn>(col4);
    ...
    // Test Date column
    {
        ...
        auto date32_array = std::static_pointer_cast<arrow::Date32Array>(arrow_array);
        
        std::vector<std::string> date_strings = {"2004-05-08", "2005-03-14", "2004-02-19"};
