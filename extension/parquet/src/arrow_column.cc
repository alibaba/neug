...
static std::shared_ptr<IColumn> convert_numeric_arrays(
...
static std::shared_ptr<IColumn> convert_string_arrays(
    const std::vector<std::shared_ptr<arrow::Array>>& arrays) {
...
static std::shared_ptr<IColumn> convert_date32_arrays(
    const std::vector<std::shared_ptr<arrow::Array>>& arrays) {
...
static std::shared_ptr<IColumn> convert_date64_arrays(
    const std::vector<std::shared_ptr<arrow::Array>>& arrays) {
  ValueColumnBuilder<date_t> builder;
  for (const auto& arr : arrays) {
...
static std::shared_ptr<IColumn> convert_timestamp_arrays(
    const std::vector<std::shared_ptr<arrow::Array>>& arrays) {
...
std::shared_ptr<IColumn> arrow_arrays_to_value_column(
    const std::vector<std::shared_ptr<arrow::Array>>& arrays) {
  if (arrays.empty()) {
...
std::shared_ptr<IColumn> arrow_array_to_value_column(
