...
/// @brief Leiden community detection function (whole-graph).
///
/// Usage in Cypher:
///   CALL leiden()
///   CALL leiden(1.0)            -- resolution
///   CALL leiden(1.0, true)      -- resolution + directed
///   CALL leiden(1.0, true, 1e-7) -- resolution + directed + threshold
///   CALL leiden(1.0, true, 1e-7, "name,age") -- + extra properties
///
...
///   - properties (STRING, optional) - JSON map of requested property values
