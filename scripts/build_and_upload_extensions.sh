...
Examples:
    ...
    $0 --extensions json --version v0.1.3 --platform linux-x86_64

    # Build multiple extensions
    $0 --extensions "json;csv" --version v0.1.3
...
for ext_file in extension_files:
    ...
    # Example: neug/extensions/v0.1.3/linux-x86_64/json/libjson.neug_extension
