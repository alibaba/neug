...
Examples:
    ...
    $0 --extensions json --version v0.2.0 --platform linux-x86_64

    # Build multiple extensions
    $0 --extensions "json;csv" --version v0.2.0
...
for ext_file in extension_files:
    ...
    # Example: neug/extensions/v0.2.0/linux-x86_64/json/libjson.neug_extension
