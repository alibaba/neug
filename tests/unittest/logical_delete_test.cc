...
class PropertyGraphLogicalDeleteTest : public ::testing::Test {
 protected:
  ...
  CreateVertexTypeParam BuildCreateVertexTypeParam(
      ...
      const std::vector<std::pair<std::string, columnar::Value>>& properties,
...
TEST_F(PropertyGraphLogicalDeleteTest, DeleteVertexType_RemovesTypeAndData) {
  ...
  std::vector<std::pair<std::string, columnar::Value>> properties = {
      {"age", columnar::Value::INT32(0)},
      {"name", columnar::Value::STRING(std::string("string"))}};
  std::vector<std::string> pk_names = {"id"};
  properties.insert(properties.begin(), {"id", columnar::Value::INT64(0L)});
...
TEST_F(PropertyGraphLogicalDeleteTest, DeleteEdgeTypePhysical_RemovesEdgeType) {
  ...
  std::vector<std::pair<std::string, columnar::Value>> v_props = {
      {"id", columnar::Value::INT64(0L)}};
  std::vector<std::string> pk_names = {"id"};
  ...
  // Create edge type
  std::vector<std::pair<std::string, columnar::Value>> e_props = {
      {"years", columnar::Value::INT32(0)}};
...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::pair<std::string, columnar::Value>> e_props = {
      {"years", columnar::Value::INT32(0)},
      {"position", columnar::Value::STRING(std::string("string"))}};
...
TEST_F(PropertyGraphLogicalDeleteTest, MultipleLogicalDeletes_WorksCorrectly) {
  std::vector<std::pair<std::string, columnar::Value>> properties = {
      ...
      {"name", columnar::Value::STRING(std::string("string"))},
      {"age", columnar::Value::INT32(0)},
      {"email", columnar::Value::STRING(std::string("string"))}};
  std::vector<std::string> pk_names = {"id"};
...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::pair<std::string, columnar::Value>> e_props_workat = {
      {"years", columnar::Value::INT32(0)},
      {"position", columnar::Value::STRING(std::string("string"))}};
  std::vector<std::pair<std::string, columnar::Value>> e_props_locatedat = {
      {"since", columnar::Value::INT32(0)},
      {"city", columnar::Value::STRING(std::string("string"))}};
  graph_.CreateEdgeType(
