...
void testOpenEmptyGraph(std::shared_ptr<neug::Checkpoint> ckp,
  ...
  // Create vertex type PERSON
  {
    ...
    properties.emplace_back(
        std::make_pair(std::string("id"), columnar::Value::INT32(0)));
    properties.emplace_back(
        std::make_pair(std::string("name"), columnar::Value::STRING("")));
    properties.emplace_back(
        std::make_pair(std::string("age"), columnar::Value::INT32(0)));
  ...
  // Create edge type PERSON-KNOWS->PERSON
  {
    ...
    std::vector<std::pair<std::string, columnar::Value>> edge_properties;
    edge_properties.emplace_back(
        std::make_pair(std::string("weight"), columnar::Value::FLOAT(0.0)));
  ...
  // Add property for PERSON-KNOWS->PERSON
  {
    ...
    std::string dst_vertex_type = "PERSON";
    std::string edge_type_name = "KNOWS";
    std::vector<std::pair<std::string, columnar::Value>> add_properties;
    add_properties.emplace_back(
        std::make_pair(std::string("creationDate"),
                       columnar::Value::TIMESTAMPMS(DateTime(0))));
