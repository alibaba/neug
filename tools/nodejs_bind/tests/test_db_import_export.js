/**
 * Strict port of tools/python_bind/tests/test_db_import_export.py to Node.js (node:test).
 * Same test names, same order, same structure, same assertions.
 *
 * Run: cd tools/nodejs_bind && node --test tests/test_db_import_export.js
 */
