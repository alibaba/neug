/**
 * Strict port of tools/python_bind/tests/test_db_query.py to Node.js (node:test).
 * Same order, same db paths, same queries, same assertions.
 *
 * Run: cd tools/nodejs_bind && node --test tests/test_db_query.js
 */
