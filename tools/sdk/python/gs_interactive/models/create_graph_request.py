...
class CreateGraphRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stored_procedures": [CreateProcedureRequest.from_dict(_item) for _item in obj.get("stored_procedures")] if obj.get("stored_procedures") is not None else None,
            "schema": CreateGraphSchemaRequest.from_dict(obj.get("schema")) if obj.get("schema") is not None else None
        })
        return _obj
