...
class GraphServiceRegistryRecord(BaseModel):
    """
    GraphServiceRegistryRecord
    """ # noqa: E501
    graph_id: Optional[StrictStr] = None
    service_registry: Optional[ServiceRegistryRecord] = None
    __properties: ClassVar[List[str]] = ["graph_id", "service_registry"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of service_registry
        if self.service_registry:
            _dict['service_registry'] = self.service_registry.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "service_registry": ServiceRegistryRecord.from_dict(obj.get("service_registry")) if obj.get("service_registry") is not None else None
        })
        return _obj
