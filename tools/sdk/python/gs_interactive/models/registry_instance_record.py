...
class RegistryInstanceRecord(BaseModel):
    """
    RegistryInstanceRecord
    """ # noqa: E501
    endpoint: Optional[StrictStr] = None
    metrics: Optional[ServiceMetrics] = None
    __properties: ClassVar[List[str]] = ["endpoint", "metrics"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "metrics": ServiceMetrics.from_dict(obj.get("metrics")) if obj.get("metrics") is not None else None
        })
        return _obj
