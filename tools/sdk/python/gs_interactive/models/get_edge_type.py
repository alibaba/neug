...
class GetEdgeType(BaseModel):
    ...
    primary_keys: Optional[List[StrictStr]] = Field(default=None, description="The primary keys of the edge type, which is optional.")
    ...
    __properties: ClassVar[List[str]] = ["type_name", "primary_keys", "vertex_type_pair_relations", "type_id", "description", "properties"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "vertex_type_pair_relations": [BaseEdgeTypeVertexTypePairRelationsInner.from_dict(_item) for _item in obj.get("vertex_type_pair_relations")] if obj.get("vertex_type_pair_relations") is not None else None,
            "type_id": obj.get("type_id"),
            "description": obj.get("description"),
            "properties": [GetPropertyMeta.from_dict(_item) for _item in obj.get("properties")] if obj.get("properties") is not None else None
        })
        return _obj
