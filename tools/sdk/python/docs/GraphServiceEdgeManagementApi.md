...
# **add_edge**
> str add_edge(graph_id, edge_request)
...
with gs_interactive.ApiClient(configuration) as api_client:
    ...
    edge_request = [{"src_label":"person","dst_label":"software","edge_label":"created","src_primary_key_values":[{"name":"id","value":1}],"dst_primary_key_values":[{"name":"id","value":3}],"properties":[{"name":"weight","value":0.2}]}] # List[EdgeRequest] | 
...
# **delete_edge**
> str delete_edge(graph_id, delete_edge_request)
...
with gs_interactive.ApiClient(configuration) as api_client:
    ...
    api_instance = gs_interactive.GraphServiceEdgeManagementApi(api_client)
    graph_id = 'graph_id_example' # str | 
    delete_edge_request = [gs_interactive.DeleteEdgeRequest()] # List[DeleteEdgeRequest] | The label and primary key values of the src and dst vertices, and the edge label.

    try:
        # Remove edge from the graph
        api_response = api_instance.delete_edge(graph_id, delete_edge_request)
...
------------- | ------------- | ------------- | -------------
 **graph_id** | **str**|  | 
 **delete_edge_request** | [**List[DeleteEdgeRequest]**](DeleteEdgeRequest.md)| The label and primary key values of the src and dst vertices, and the edge label. | 
...
# **update_edge**
> str update_edge(graph_id, edge_request)
...
with gs_interactive.ApiClient(configuration) as api_client:
    ...
    try:
        # Update edge's property
        api_response = api_instance.update_edge(graph_id, edge_request)
