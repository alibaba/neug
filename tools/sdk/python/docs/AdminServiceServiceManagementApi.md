...
------------- | ------------- | -------------
[**check_service_ready**](AdminServiceServiceManagementApi.md#check_service_ready) | **GET** /v1/service/ready | 
...
with gs_interactive.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.check_service_ready()
        print("The response of AdminServiceServiceManagementApi->check_service_ready:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdminServiceServiceManagementApi->check_service_ready: %s\n" % e)
```
...
# **stop_service**
> str stop_service(stop_service_request=stop_service_request)
...
with gs_interactive.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gs_interactive.AdminServiceServiceManagementApi(api_client)
    stop_service_request = gs_interactive.StopServiceRequest() # StopServiceRequest | Stop service on a specified graph (optional)

    try:
        api_response = api_instance.stop_service(stop_service_request=stop_service_request)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stop_service_request** | [**StopServiceRequest**](StopServiceRequest.md)| Stop service on a specified graph | [optional] 
