...
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-x86_64
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-arm64

# Development images
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-dev:v0.2.0-x86_64
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-dev:v0.2.0-arm64
```
...
docker tag graphscope/neug-manylinux:${ARCH} neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-${ARCH}
```
...
```bash
bash ./manifest.sh neug-manylinux v0.2.0 hongkong create
bash ./manifest.sh neug v0.2.0 hongkong create
bash ./manifest.sh neug-dev v0.2.0 hongkong create
```
...
```bash
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-x86_64-node
docker pull neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-arm64-node
```
...
```bash
export ARCH=arm64 # x86_64
docker tag neug/neug-manylinux:${ARCH}-node neug-registry.cn-hongkong.cr.aliyuncs.com/neug/neug-manylinux:v0.2.0-${ARCH}-node
```
