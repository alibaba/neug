...
#ifndef UTILS_PTHASH_UTILS_ENCODERS_VIEW_VIEW_H_
#define UTILS_PTHASH_UTILS_ENCODERS_VIEW_VIEW_H_

#ifdef USE_PTHASH
#include "neug/utils/pthash_utils/ef_sequence_view.h"
...
#endif  // UTILS_PTHASH_UTILS_ENCODERS_VIEW_VIEW_H_