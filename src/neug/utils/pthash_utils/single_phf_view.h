...
#ifndef UTILS_PTHASH_UTILS_SINGLE_PHF_VIEW_H_
#define UTILS_PTHASH_UTILS_SINGLE_PHF_VIEW_H_

#ifdef USE_PTHASH

#include "neug/utils/mmap_array.h"
#include "neug/utils/pthash_utils/encoders_view.h"
...
#endif  // UTILS_PTHASH_UTILS_SINGLE_PHF_VIEW_H_