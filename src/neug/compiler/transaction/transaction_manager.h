...
#include "neug/compiler/common/uniq_lock.h"
...
class TransactionManager {
 ...
 public:
  ...
  virtual void rollback(main::ClientContext& clientContext,
 ...
 private:
  ...
  bool hasActiveWriteTransactionNoLock() const {
    return !activeWriteTransactions.empty();
  }

  void setCheckPointWaitTimeoutForTransactionsToLeaveInMicros(
      uint64_t waitTimeInMicros) {
