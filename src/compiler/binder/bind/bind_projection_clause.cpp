...
#include "src/include/binder/query/return_with_clause/bound_return_clause.h"
#include "src/include/binder/query/return_with_clause/bound_with_clause.h"
#include "src/include/common/exception/binder.h"
#include "src/include/parser/expression/parsed_property_expression.h"
#include "src/include/parser/query/return_with_clause/with_clause.h"
...
BoundProjectionBody Binder::bindProjectionBody(
  ...
  if (projectionBody.hasOrderByExpressions()) {
    ...
    if (boundProjectionBody.hasAggregateExpressions() ||
      ...
      scope.clear();
      KU_ASSERT(projectionBody.getProjectionExpressions().size() ==
