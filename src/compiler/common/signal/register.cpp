...
void handler(int signo) {
  // Not safe. Safe method would be writing directly to stderr with a
  // pre-defined string But since the below isn't safe either...
  ...
  // Since this is only used in CI, the occasional failure/hang is probably
  // acceptable.
