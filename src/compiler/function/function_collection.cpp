#include "src/include/function/function_collection.h"

#include "src/include/function/aggregate/count.h"
#include "src/include/function/aggregate/count_star.h"
#include "src/include/function/arithmetic/vector_arithmetic_functions.h"
#include "src/include/function/array/vector_array_functions.h"
#include "src/include/function/blob/vector_blob_functions.h"
#include "src/include/function/cast/vector_cast_functions.h"
#include "src/include/function/comparison/vector_comparison_functions.h"
#include "src/include/function/date/vector_date_functions.h"
#include "src/include/function/export/export_function.h"
#include "src/include/function/hash/vector_hash_functions.h"
#include "src/include/function/internal_id/vector_internal_id_functions.h"
#include "src/include/function/interval/vector_interval_functions.h"
#include "src/include/function/list/vector_list_functions.h"
#include "src/include/function/map/vector_map_functions.h"
#include "src/include/function/path/vector_path_functions.h"
...
#include "src/include/function/string/vector_string_functions.h"
#include "src/include/function/struct/vector_struct_functions.h"
#include "src/include/function/table/simple_table_function.h"
#include "src/include/function/table/standalone_call_function.h"
#include "src/include/function/timestamp/vector_timestamp_functions.h"
#include "src/include/function/union/vector_union_functions.h"
#include "src/include/function/utility/vector_utility_functions.h"
...
FunctionCollection* FunctionCollection::getFunctions() {
  static FunctionCollection functions[] = {
      ...
      SCALAR_FUNCTION(AbsFunction), SCALAR_FUNCTION(AcosFunction),
      SCALAR_FUNCTION(AsinFunction), SCALAR_FUNCTION(AtanFunction),
      SCALAR_FUNCTION(Atan2Function), SCALAR_FUNCTION(BitwiseXorFunction),
      SCALAR_FUNCTION(BitwiseAndFunction), SCALAR_FUNCTION(BitwiseOrFunction),
      ...
      SCALAR_FUNCTION(RoundFunction), SCALAR_FUNCTION(SinFunction),
      SCALAR_FUNCTION(SignFunction), SCALAR_FUNCTION(SqrtFunction),
      ...
      SCALAR_FUNCTION(ListReverseFunction), SCALAR_FUNCTION(SizeFunction),
      SCALAR_FUNCTION(ListToStringFunction),
      SCALAR_FUNCTION(ListTransformFunction),
      SCALAR_FUNCTION(ListFilterFunction), SCALAR_FUNCTION(ListReduceFunction),
      SCALAR_FUNCTION(ListAnyFunction), SCALAR_FUNCTION(ListAllFunction),
      SCALAR_FUNCTION(ListNoneFunction), SCALAR_FUNCTION(ListSingleFunction),
      ...
      SCALAR_FUNCTION(StructExtractFunctions), REWRITE_FUNCTION(KeysFunctions),
      ...
      TABLE_FUNCTION(CatalogVersionFunction), TABLE_FUNCTION(DBVersionFunction),
      TABLE_FUNCTION(ShowTablesFunction), TABLE_FUNCTION(FreeSpaceInfoFunction),
