...
static inline bool addInPlaceWithOverflowCheck(SRC_TYPE left, SRC_TYPE right,
                                               SRC_TYPE& result) {
  DST_TYPE uresult;
...
template <>
bool inline AddInPlace::operation(uint8_t& left, uint8_t& right,
                                  uint8_t& result) {
  return addInPlaceWithOverflowCheck<uint8_t, uint16_t>(left, right, result);
}

template <>
bool inline AddInPlace::operation(uint16_t& left, uint16_t& right,
                                  uint16_t& result) {
  return addInPlaceWithOverflowCheck<uint16_t, uint32_t>(left, right, result);
}

template <>
bool inline AddInPlace::operation(uint32_t& left, uint32_t& right,
                                  uint32_t& result) {
...
template <>
bool inline AddInPlace::operation(int16_t& left, int16_t& right,
                                  int16_t& result) {
  return addInPlaceWithOverflowCheck<int16_t, int32_t>(left, right, result);
}

template <>
bool inline AddInPlace::operation(int32_t& left, int32_t& right,
                                  int32_t& result) {
