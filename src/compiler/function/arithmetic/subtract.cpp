...
static inline bool SubtractInPlaceWithOverflowCheck(SRC_TYPE left,
                                                    SRC_TYPE right,
                                                    SRC_TYPE& result) {
  DST_TYPE uresult;
...
template <>
bool inline SubtractInPlace::operation(uint8_t& left, uint8_t& right,
                                       uint8_t& result) {
  if (right > left) {
    return false;
  }
  return SubtractInPlaceWithOverflowCheck<uint8_t, uint16_t>(left, right,
                                                             result);
}

template <>
bool inline SubtractInPlace::operation(uint16_t& left, uint16_t& right,
                                       uint16_t& result) {
  if (right > left) {
    return false;
  }
  return SubtractInPlaceWithOverflowCheck<uint16_t, uint32_t>(left, right,
                                                              result);
}

template <>
bool inline SubtractInPlace::operation(uint32_t& left, uint32_t& right,
                                       uint32_t& result) {
  if (right > left) {
    return false;
  }
  return SubtractInPlaceWithOverflowCheck<uint32_t, uint64_t>(left, right,
                                                              result);
}

template <>
bool SubtractInPlace::operation(uint64_t& left, uint64_t& right,
                                uint64_t& result) {
  if (right > left) {
    return false;
  }
  return SubtractInPlaceWithOverflowCheck<uint64_t, uint64_t>(left, right,
                                                              result);
}

template <>
bool inline SubtractInPlace::operation(int8_t& left, int8_t& right,
                                       int8_t& result) {
  return SubtractInPlaceWithOverflowCheck<int8_t, int16_t>(left, right, result);
}

template <>
bool inline SubtractInPlace::operation(int16_t& left, int16_t& right,
                                       int16_t& result) {
  return SubtractInPlaceWithOverflowCheck<int16_t, int32_t>(left, right,
                                                            result);
}

template <>
bool inline SubtractInPlace::operation(int32_t& left, int32_t& right,
                                       int32_t& result) {
  return SubtractInPlaceWithOverflowCheck<int32_t, int64_t>(left, right,
                                                            result);
}

template <>
bool SubtractInPlace::operation(int64_t& left, int64_t& right,
                                int64_t& result) {
