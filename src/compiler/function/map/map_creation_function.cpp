#include "src/include/function/map/functions/map_creation_function.h"
...
function_set MapCreationFunctions::getFunctionSet() {
  auto execFunc =
      ScalarFunction::BinaryExecWithBindData<list_entry_t, list_entry_t,
