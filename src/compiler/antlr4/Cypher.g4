...
nEUG_CreateIndex
    : CREATE SP INDEX SP oC_SchemaName (SP nEUG_IfNotExists)? SP ON SP oC_SchemaName SP USING SP oC_SchemaName SP? '(' SP? nEUG_CreateIndexColumnList SP? ')' (SP nEUG_CreateIndexOptions)? ;
