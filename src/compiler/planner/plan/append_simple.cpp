...
#include "src/include/binder/bound_detach_database.h"
#include "src/include/binder/bound_explain.h"
#include "src/include/binder/bound_extension_statement.h"
...
#include "src/include/binder/ddl/bound_alter.h"
#include "src/include/binder/ddl/bound_create_sequence.h"
#include "src/include/binder/ddl/bound_create_table.h"
#include "src/include/binder/ddl/bound_create_type.h"
#include "src/include/binder/ddl/bound_drop.h"
#include "src/include/planner/operator/ddl/logical_alter.h"
#include "src/include/planner/operator/ddl/logical_create_sequence.h"
#include "src/include/planner/operator/ddl/logical_create_table.h"
#include "src/include/planner/operator/ddl/logical_create_type.h"
#include "src/include/planner/operator/ddl/logical_drop.h"
#include "src/include/planner/operator/logical_create_macro.h"
#include "src/include/planner/operator/logical_explain.h"
#include "src/include/planner/operator/logical_standalone_call.h"
#include "src/include/planner/operator/logical_table_function_call.h"
#include "src/include/planner/operator/logical_transaction.h"
#include "src/include/planner/operator/simple/logical_attach_database.h"
#include "src/include/planner/operator/simple/logical_detach_database.h"
#include "src/include/planner/operator/simple/logical_extension.h"
#include "src/include/planner/operator/simple/logical_use_database.h"
...
void Planner::appendStandaloneCallFunction(const BoundStatement& statement,
  ...
  std::shared_ptr<LogicalOperator> op =
      std::make_shared<LogicalTableFunctionCall>(
          standaloneCallFunctionClause.getTableFunction(),
