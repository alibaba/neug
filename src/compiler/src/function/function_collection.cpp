...
FunctionCollection* FunctionCollection::getFunctions() {
  static FunctionCollection functions[] = {
      ...
      SCALAR_FUNCTION(AcosFunction),
      SCALAR_FUNCTION(AsinFunction),
      SCALAR_FUNCTION(AtanFunction),
      SCALAR_FUNCTION(Atan2Function),
      SCALAR_FUNCTION(BitwiseXorFunction),
      SCALAR_FUNCTION(BitwiseAndFunction),
      SCALAR_FUNCTION(BitwiseOrFunction),
      SCALAR_FUNCTION(BitShiftLeftFunction),
      SCALAR_FUNCTION(BitShiftRightFunction),
      SCALAR_FUNCTION(CbrtFunction),
      SCALAR_FUNCTION(CeilFunction),
      SCALAR_FUNCTION_ALIAS(CeilingFunction),
      SCALAR_FUNCTION(CosFunction),
      SCALAR_FUNCTION(CotFunction),
      SCALAR_FUNCTION(DegreesFunction),
      SCALAR_FUNCTION(EvenFunction),
      SCALAR_FUNCTION(FactorialFunction),
      SCALAR_FUNCTION(FloorFunction),
      SCALAR_FUNCTION(GammaFunction),
      SCALAR_FUNCTION(LgammaFunction),
      SCALAR_FUNCTION(LnFunction),
      SCALAR_FUNCTION(LogFunction),
      SCALAR_FUNCTION_ALIAS(Log10Function),
      SCALAR_FUNCTION(Log2Function),
      SCALAR_FUNCTION(NegateFunction),
      SCALAR_FUNCTION(PiFunction),
      SCALAR_FUNCTION_ALIAS(PowFunction),
      SCALAR_FUNCTION(RadiansFunction),
      SCALAR_FUNCTION(RoundFunction),
      SCALAR_FUNCTION(SinFunction),
      SCALAR_FUNCTION(SignFunction),
      SCALAR_FUNCTION(SqrtFunction),
      SCALAR_FUNCTION(TanFunction),

      SCALAR_FUNCTION(ArrayExtractFunction),
      SCALAR_FUNCTION(ConcatFunction),
      ...
      SCALAR_FUNCTION(LeftFunction),
      SCALAR_FUNCTION(LpadFunction),
      SCALAR_FUNCTION(LtrimFunction),
      SCALAR_FUNCTION(StartsWithFunction),
      SCALAR_FUNCTION_ALIAS(PrefixFunction),
      SCALAR_FUNCTION(RepeatFunction),
      SCALAR_FUNCTION(ReverseFunction),
      SCALAR_FUNCTION(RightFunction),
      SCALAR_FUNCTION(RpadFunction),
      SCALAR_FUNCTION(RtrimFunction),
      ...
      SCALAR_FUNCTION(TrimFunction),
      SCALAR_FUNCTION(UpperFunction),
      SCALAR_FUNCTION_ALIAS(UCaseFunction),
      SCALAR_FUNCTION_ALIAS(ToUpperFunction),
      SCALAR_FUNCTION(RegexpFullMatchFunction),
      SCALAR_FUNCTION(RegexpMatchesFunction),
      SCALAR_FUNCTION(RegexpReplaceFunction),
      SCALAR_FUNCTION(RegexpExtractFunction),
      SCALAR_FUNCTION(RegexpExtractAllFunction),
      SCALAR_FUNCTION(LevenshteinFunction),
      SCALAR_FUNCTION(RegexpSplitToArrayFunction),
      SCALAR_FUNCTION(InitCapFunction),
      SCALAR_FUNCTION(StringSplitFunction),
      SCALAR_FUNCTION_ALIAS(StrSplitFunction),
      SCALAR_FUNCTION_ALIAS(StringToArrayFunction),
      SCALAR_FUNCTION(SplitPartFunction),
      SCALAR_FUNCTION(InternalIDCreationFunction),

      SCALAR_FUNCTION(ArrayValueFunction),
      SCALAR_FUNCTION(ArrayCrossProductFunction),
      SCALAR_FUNCTION(ArrayCosineSimilarityFunction),
      SCALAR_FUNCTION(ArrayDistanceFunction),
      SCALAR_FUNCTION(ArraySquaredDistanceFunction),
      SCALAR_FUNCTION(ArrayInnerProductFunction),
      SCALAR_FUNCTION(ArrayDotProductFunction),

      SCALAR_FUNCTION(ListCreationFunction),
      SCALAR_FUNCTION(ListRangeFunction),
      SCALAR_FUNCTION(ListExtractFunction),
      SCALAR_FUNCTION_ALIAS(ListElementFunction),
      SCALAR_FUNCTION(ListConcatFunction),
      SCALAR_FUNCTION_ALIAS(ListCatFunction),
      SCALAR_FUNCTION(ArrayConcatFunction),
      SCALAR_FUNCTION_ALIAS(ArrayCatFunction),
      SCALAR_FUNCTION(ListAppendFunction),
      SCALAR_FUNCTION(ArrayAppendFunction),
      SCALAR_FUNCTION_ALIAS(ArrayPushFrontFunction),
      SCALAR_FUNCTION(ListPrependFunction),
      SCALAR_FUNCTION(ArrayPrependFunction),
      SCALAR_FUNCTION_ALIAS(ArrayPushBackFunction),
      SCALAR_FUNCTION(ListPositionFunction),
      SCALAR_FUNCTION_ALIAS(ListIndexOfFunction),
      SCALAR_FUNCTION(ArrayPositionFunction),
      SCALAR_FUNCTION_ALIAS(ArrayIndexOfFunction),
      SCALAR_FUNCTION(ListContainsFunction),
      SCALAR_FUNCTION_ALIAS(ListHasFunction),
      SCALAR_FUNCTION(ArrayContainsFunction),
      SCALAR_FUNCTION_ALIAS(ArrayHasFunction),
      SCALAR_FUNCTION(ListSliceFunction),
      SCALAR_FUNCTION(ArraySliceFunction),
      SCALAR_FUNCTION(ListSortFunction),
      SCALAR_FUNCTION(ListReverseSortFunction),
      SCALAR_FUNCTION(ListSumFunction),
      SCALAR_FUNCTION(ListProductFunction),
      SCALAR_FUNCTION(ListDistinctFunction),
      SCALAR_FUNCTION(ListUniqueFunction),
      SCALAR_FUNCTION(ListAnyValueFunction),
      SCALAR_FUNCTION(ListReverseFunction),
      SCALAR_FUNCTION(SizeFunction),
      SCALAR_FUNCTION(ListToStringFunction),
      SCALAR_FUNCTION(ListTransformFunction),
      SCALAR_FUNCTION(ListFilterFunction),
      SCALAR_FUNCTION(ListReduceFunction),
      SCALAR_FUNCTION(ListAnyFunction),
      SCALAR_FUNCTION(ListAllFunction),
      SCALAR_FUNCTION(ListNoneFunction),
      SCALAR_FUNCTION(ListSingleFunction),
      SCALAR_FUNCTION(ListHasAllFunction),
      ...
      SCALAR_FUNCTION(CastToBlobFunction),
      SCALAR_FUNCTION_ALIAS(BlobFunction),
      SCALAR_FUNCTION(CastToUUIDFunction),
      SCALAR_FUNCTION_ALIAS(UUIDFunction),
      SCALAR_FUNCTION(CastToDoubleFunction),
      SCALAR_FUNCTION(CastToFloatFunction),
      SCALAR_FUNCTION(CastToSerialFunction),
      SCALAR_FUNCTION(CastToInt64Function),
      SCALAR_FUNCTION(CastToInt32Function),
      SCALAR_FUNCTION(CastToInt16Function),
      SCALAR_FUNCTION(CastToInt8Function),
      SCALAR_FUNCTION(CastToUInt64Function),
      SCALAR_FUNCTION(CastToUInt32Function),
      SCALAR_FUNCTION(CastToUInt16Function),
      SCALAR_FUNCTION(CastToUInt8Function),
      SCALAR_FUNCTION(CastToInt128Function),
      SCALAR_FUNCTION(CastToBoolFunction),
      ...
      SCALAR_FUNCTION(DateTruncFunction),
      SCALAR_FUNCTION_ALIAS(DateTruncFunctionAlias),
      SCALAR_FUNCTION(DayNameFunction),
      SCALAR_FUNCTION(GreatestFunction),
      SCALAR_FUNCTION(LastDayFunction),
      SCALAR_FUNCTION(LeastFunction),
      SCALAR_FUNCTION(MakeDateFunction),
      SCALAR_FUNCTION(MonthNameFunction),
      SCALAR_FUNCTION(CurrentDateFunction),

      SCALAR_FUNCTION(CenturyFunction),
      SCALAR_FUNCTION(EpochMsFunction),
      SCALAR_FUNCTION(ToTimestampFunction),
      SCALAR_FUNCTION(CurrentTimestampFunction),
      SCALAR_FUNCTION(ToEpochMsFunction),

      SCALAR_FUNCTION(ToYearsFunction),
      SCALAR_FUNCTION(ToMonthsFunction),
      SCALAR_FUNCTION(ToDaysFunction),
      SCALAR_FUNCTION(ToHoursFunction),
      SCALAR_FUNCTION(ToMinutesFunction),
      SCALAR_FUNCTION(ToSecondsFunction),
      SCALAR_FUNCTION(ToMillisecondsFunction),
      SCALAR_FUNCTION(ToMicrosecondsFunction),

      SCALAR_FUNCTION(OctetLengthFunctions),
      SCALAR_FUNCTION(EncodeFunctions),
      ...
      SCALAR_FUNCTION(MapCreationFunctions),
      SCALAR_FUNCTION(MapExtractFunctions),
      SCALAR_FUNCTION_ALIAS(ElementAtFunctions),
      SCALAR_FUNCTION_ALIAS(CardinalityFunction),
      SCALAR_FUNCTION(MapKeysFunctions),
      SCALAR_FUNCTION(MapValuesFunctions),

      SCALAR_FUNCTION(UnionValueFunction),
      SCALAR_FUNCTION(UnionTagFunction),
      SCALAR_FUNCTION(UnionExtractFunction),

      SCALAR_FUNCTION(OffsetFunction),
      ...
      SCALAR_FUNCTION(MD5Function),
      SCALAR_FUNCTION(SHA256Function),
      SCALAR_FUNCTION(HashFunction),

      SCALAR_FUNCTION(CoalesceFunction),
      SCALAR_FUNCTION(IfNullFunction),
      SCALAR_FUNCTION(ConstantOrNullFunction),
      SCALAR_FUNCTION(CountIfFunction),
      SCALAR_FUNCTION(ErrorFunction),
      REWRITE_FUNCTION(NullIfFunction),
      SCALAR_FUNCTION(TypeOfFunction),

      SCALAR_FUNCTION(CurrValFunction),
      SCALAR_FUNCTION(NextValFunction),
