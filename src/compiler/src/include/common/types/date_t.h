...
class Date {
 public:
  ...
  // successful
  KUZU_API static bool tryConvertDate(const char* buf, uint64_t len,
  ...
  KUZU_API static void convert(date_t date, int32_t& out_year,
  ...
  // 3, "3" -> 3)
  KUZU_API static bool parseDoubleDigit(const char* buf, uint64_t len,
