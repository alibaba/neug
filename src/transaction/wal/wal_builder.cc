...
void WalBuilder::LogInsertVertex(label_t label, const columnar::Value& oid,
                                 const std::vector<columnar::Value>& props) {
  InsertVertexRedo::Serialize(arc_, label, oid, props);
  ++op_num_;
}

void WalBuilder::LogInsertEdge(label_t src_label, const columnar::Value& src,
                               label_t dst_label, const columnar::Value& dst,
                               label_t edge_label,
...
void WalBuilder::LogUpdateVertexProp(label_t label, const columnar::Value& oid,
                                     int prop_id,
...
void WalBuilder::LogUpdateEdgeProp(
    label_t src_label, const columnar::Value& src, label_t dst_label,
    const columnar::Value& dst, label_t edge_label, int32_t oe_offset,
    int32_t ie_offset, int prop_id, const columnar::Value& value) {
...
void WalBuilder::LogRemoveVertex(label_t label, const columnar::Value& oid) {
  RemoveVertexRedo::Serialize(arc_, label, oid);
  ++op_num_;
}

void WalBuilder::LogRemoveEdge(label_t src_label, const columnar::Value& src,
                               label_t dst_label, const columnar::Value& dst,
