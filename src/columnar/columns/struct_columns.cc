...
namespace neug {
namespace columnar {
std::shared_ptr<IColumn> StructColumn::shuffle(const sel_vec_t& offsets) const {
  std::vector<std::shared_ptr<IColumn>> shuffled_children;
...
std::shared_ptr<IColumn> StructColumn::optional_shuffle(
...
std::shared_ptr<IColumn> StructColumnBuilder::finish() {
