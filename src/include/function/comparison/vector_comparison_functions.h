...
struct ComparisonFunction {
  ...
  static function_set getFunctionSet(const std::string& name) {
    ...
    for (auto& comparableType :
         common::LogicalTypeUtils::getAllValidLogicTypeIDs()) {
 ...
 private:
  ...
  // dataType. So we only need to switch the physical type to get the
  // corresponding exec function.
  template <typename FUNC>
  static void getExecFunc(common::PhysicalTypeID leftType,
                          common::PhysicalTypeID rightType,
    ...
    case common::PhysicalTypeID::INT128: {
      func = BinaryComparisonExecFunction<common::int128_t, common::int128_t,
                                          uint8_t, FUNC>;
    } break;
    ...
    case common::PhysicalTypeID::LIST: {
      func = BinaryComparisonExecFunction<common::list_entry_t,
                                          common::list_entry_t, uint8_t, FUNC>;
    } break;
    case common::PhysicalTypeID::STRUCT: {
      func =
          BinaryComparisonExecFunction<common::struct_entry_t,
  ...
  static void getSelectFunc(common::PhysicalTypeID leftTypeID,
    ...
    case common::PhysicalTypeID::INT128: {
      func = BinaryComparisonSelectFunction<common::int128_t, common::int128_t,
                                            FUNC>;
    } break;
    case common::PhysicalTypeID::DOUBLE: {
    ...
    case common::PhysicalTypeID::ARRAY:
    case common::PhysicalTypeID::LIST: {
      func = BinaryComparisonSelectFunction<common::list_entry_t,
                                            common::list_entry_t, FUNC>;
    } break;
    case common::PhysicalTypeID::STRUCT: {
      func = BinaryComparisonSelectFunction<common::struct_entry_t,
