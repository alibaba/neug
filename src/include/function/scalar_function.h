...
using scalar_func_compile_exec_t = std::function<void(
    FunctionBindData*, const std::vector<std::shared_ptr<common::ValueVector>>&,
...
using scalar_func_exec_t =
    std::function<void(const std::vector<std::shared_ptr<common::ValueVector>>&,
                       ...
                       common::ValueVector&, common::SelectionVector*, void*)>;
// Execute boolean function and write result to selection vector. Fast path for
// filter.
