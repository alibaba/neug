...
struct int128_t {
  ...
  int128_t() = default;
  int128_t(
      int64_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      int32_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      int16_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      int8_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      uint64_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      uint32_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      uint16_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      uint8_t value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      double value);  // NOLINT: Allow implicit conversion from numeric values
  int128_t(
      float value);  // NOLINT: Allow implicit conversion from numeric values
...
class Int128_t {
 public:
  ...
  static int128_t divModPositive(int128_t lhs, uint64_t rhs,
                                 uint64_t& remainder);
