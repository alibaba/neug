...
enum class WALRecordType : uint8_t {
  INVALID_RECORD =
      0,  // This is not used for any record. 0 is reserved to detect cases
          // where we accidentally read from an empty buffer.
...
struct BeginTransactionRecord final : WALRecord {
  BeginTransactionRecord()
      : WALRecord{WALRecordType::BEGIN_TRANSACTION_RECORD} {}
...
struct RollbackRecord final : WALRecord {
  ...
  void serialize(common::Serializer& serializer) const override;
  static std::unique_ptr<RollbackRecord> deserialize(
      common::Deserializer& deserializer);
};
...
struct CreateCatalogEntryRecord final : WALRecord {
  ...
  CreateCatalogEntryRecord()
      : WALRecord{WALRecordType::CREATE_CATALOG_ENTRY_RECORD},
...
struct CopyTableRecord final : WALRecord {
  ...
  CopyTableRecord()
      : WALRecord{WALRecordType::COPY_TABLE_RECORD},
        tableID{common::INVALID_TABLE_ID} {}
...
struct DropCatalogEntryRecord final : WALRecord {
  ...
  DropCatalogEntryRecord()
      : WALRecord{WALRecordType::DROP_CATALOG_ENTRY_RECORD},
        entryID{common::INVALID_OID},
        entryType{} {}
  DropCatalogEntryRecord(common::table_id_t entryID,
                         catalog::CatalogEntryType entryType)
      : WALRecord{WALRecordType::DROP_CATALOG_ENTRY_RECORD},
        entryID{entryID},
        entryType{entryType} {}
...
struct AlterTableEntryRecord final : WALRecord {
  ...
  AlterTableEntryRecord()
      : WALRecord{WALRecordType::ALTER_TABLE_ENTRY_RECORD},
        alterInfo{nullptr} {}
...
struct UpdateSequenceRecord final : WALRecord {
  ...
  UpdateSequenceRecord()
      : WALRecord{WALRecordType::UPDATE_SEQUENCE_RECORD},
        sequenceID{0},
        kCount{0} {}
...
struct TableInsertionRecord final : WALRecord {
  ...
  TableInsertionRecord(common::table_id_t tableID, common::TableType tableType,
      ...
      : WALRecord{WALRecordType::TABLE_INSERTION_RECORD},
        ...
        vectors{vectors} {}
  TableInsertionRecord(
      common::table_id_t tableID, common::TableType tableType,
      common::row_idx_t numRows,
...
struct NodeDeletionRecord final : WALRecord {
  ...
  NodeDeletionRecord()
      : WALRecord{WALRecordType::NODE_DELETION_RECORD},
        tableID{common::INVALID_TABLE_ID},
        nodeOffset{common::INVALID_OFFSET},
        pkVector{nullptr} {}
...
struct NodeUpdateRecord final : WALRecord {
  ...
  NodeUpdateRecord()
      : WALRecord{WALRecordType::NODE_UDPATE_RECORD},
        tableID{common::INVALID_TABLE_ID},
        columnID{common::INVALID_COLUMN_ID},
        nodeOffset{common::INVALID_OFFSET},
...
struct RelDetachDeleteRecord final : WALRecord {
  ...
  RelDetachDeleteRecord()
      : WALRecord{WALRecordType::REL_DETACH_DELETE_RECORD},
        ...
        srcNodeIDVector{nullptr} {}
  RelDetachDeleteRecord(common::table_id_t tableID,
                        common::RelDataDirection direction,
                        common::ValueVector* srcNodeIDVector)
      : WALRecord{WALRecordType::REL_DETACH_DELETE_RECORD},
        tableID{tableID},
