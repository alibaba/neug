...
#include "src/include/common/timer.h"
#include "src/include/common/types/value/value.h"
#include "src/include/function/table/scan_replacement.h"
#include "src/include/main/client_config.h"
#include "src/include/parser/statement.h"
#include "src/include/processor/warning_context.h"
#include "src/include/transaction/transaction_context.h"
...
class KUZU_API ClientContext {
 ...
 private:
  struct TransactionHelper {
    ...
    static TransactionCommitAction getAction(bool commitIfNew,
                                             bool commitIfAuto);
  ...
  static std::unique_ptr<QueryResult> queryResultWithError(
      std::string_view errMsg);
  static std::unique_ptr<PreparedStatement> preparedStatementWithError(
      std::string_view errMsg);
  static void bindParametersNoLock(
  ...
  std::unique_ptr<QueryResult> queryNoLock(
      std::string_view query, std::optional<uint64_t> queryID = std::nullopt);
