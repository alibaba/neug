...
#include "src/include/binder/copy/bound_query_scan_info.h"
#include "src/include/common/enums/scan_source_type.h"
#include "src/include/function/table/scan_file_function.h"
