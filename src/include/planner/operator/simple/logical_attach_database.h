...
#include "src/include/binder/bound_attach_info.h"
...
struct LogicalAttachDatabasePrintInfo final : OPPrintInfo {
  ...
  explicit LogicalAttachDatabasePrintInfo(std::string dbName)
...
class LogicalAttachDatabase final : public LogicalSimple {
 public:
  explicit LogicalAttachDatabase(
      binder::AttachInfo attachInfo,
      std::shared_ptr<binder::Expression> outputExpression)
      : LogicalSimple{LogicalOperatorType::ATTACH_DATABASE,
