...
class AdminServiceGraphManagementApi:
    ...
    def create_dataloading_job(
        self,
        graph_id: Annotated[StrictStr, Field(description="The id of graph to do bulk loading.")],
        ...
        :param graph_id: The id of graph to do bulk loading. (required)
        :type graph_id: str
    ...
    def _create_edge_type_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/graph/{graph_id}/schema/edge',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _create_vertex_type_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/graph/{graph_id}/schema/vertex',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_graph(
        ...
        :param graph_id: The id of graph to delete (required)
        :type graph_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "str",
            '404': "APIResponseWithCode",
            '500': "APIResponseWithCode",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def get_graph(
        ...
        :param graph_id: The id of graph to get (required)
        :type graph_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_schema(
        self,
        graph_id: Annotated[StrictStr, Field(description="The id of graph to get schema")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param graph_id: The id of graph to get schema (required)
        :type graph_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_snapshot_status(
        ...
        _param = self._get_snapshot_status_serialize(
            graph_id=graph_id,
    ...
    @validate_call
    def get_snapshot_status_with_http_info(
        self,
        graph_id: StrictStr,
        snapshot_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    def get_snapshot_status_without_preload_content(
        self,
        graph_id: StrictStr,
        snapshot_id: StrictInt,
        _request_timeout: Union[
    ...
    def _get_snapshot_status_serialize(
        self,
        graph_id,
        snapshot_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/graph/{graph_id}/snapshot/{snapshot_id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_edge_type(
        ...
        :param graph_id: (required)
        :type graph_id: str
        :param create_edge_type: (required)
        :type create_edge_type: CreateEdgeType
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._update_edge_type_serialize(
            graph_id=graph_id,
            create_edge_type=create_edge_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_edge_type_with_http_info(
        self,
        graph_id: StrictStr,
        create_edge_type: CreateEdgeType,
        _request_timeout: Union[
    ...
    @validate_call
    def update_edge_type_without_preload_content(
        self,
        graph_id: StrictStr,
        create_edge_type: CreateEdgeType,
        _request_timeout: Union[
    ...
    def _update_edge_type_serialize(
        self,
        graph_id,
        create_edge_type,
        _request_auth,
    ...
    def update_vertex_type(
        ...
        _param = self._update_vertex_type_serialize(
            graph_id=graph_id,
            create_vertex_type=create_vertex_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_vertex_type_with_http_info(
        self,
        graph_id: StrictStr,
        create_vertex_type: CreateVertexType,
        _request_timeout: Union[
    ...
    @validate_call
    def update_vertex_type_without_preload_content(
        self,
        graph_id: StrictStr,
        create_vertex_type: CreateVertexType,
        _request_timeout: Union[
    ...
    def _update_vertex_type_serialize(
        self,
        graph_id,
        create_vertex_type,
        _request_auth,
