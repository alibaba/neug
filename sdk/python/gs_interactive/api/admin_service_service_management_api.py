...
class AdminServiceServiceManagementApi:
    ...
    def check_service_ready(
        ...
        _param = self._check_service_ready_serialize(
    ...
    @validate_call
    def check_service_ready_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def check_service_ready_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _check_service_ready_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/service/ready',
    ...
    def stop_service(
        self,
        stop_service_request: Annotated[Optional[StopServiceRequest], Field(description="Stop service on a specified graph")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type stop_service_request: StopServiceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._stop_service_serialize(
            stop_service_request=stop_service_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _stop_service_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if stop_service_request is not None:
            _body_params = stop_service_request
