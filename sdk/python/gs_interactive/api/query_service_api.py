...
class QueryServiceApi:
    ...
    def call_proc(
        ...
        _param = self._call_proc_serialize(
            graph_id=graph_id,
            body=body,
    ...
    @validate_call
    def call_proc_without_preload_content(
        self,
        graph_id: StrictStr,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
    ...
    def call_proc_current(
        ...
        _param = self._call_proc_current_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def call_proc_current_with_http_info(
        self,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def call_proc_current_without_preload_content(
        self,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
            None,
    ...
    def _call_proc_current_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    def run_adhoc(
        ...
        _param = self._run_adhoc_serialize(
            graph_id=graph_id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def run_adhoc_without_preload_content(
        self,
        graph_id: StrictStr,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
    ...
    def _run_adhoc_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/graph/{graph_id}/adhoc_query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_adhoc_current(
        ...
        _param = self._run_adhoc_current_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_adhoc_current_with_http_info(
        self,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_adhoc_current_without_preload_content(
        self,
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
            None,
    ...
    def _run_adhoc_current_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/graph/current/adhoc_query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
