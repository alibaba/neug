...
class CreateEdgeType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type_name", "primary_keys", "vertex_type_pair_relations", "properties"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [CreatePropertyMeta.from_dict(_item) for _item in obj.get("properties")] if obj.get("properties") is not None else None
        })
        return _obj
