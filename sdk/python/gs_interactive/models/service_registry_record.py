...
class ServiceRegistryRecord(BaseModel):
    """
    ServiceRegistryRecord
    """ # noqa: E501
    service_name: Optional[StrictStr] = None
    instances: Optional[List[RegistryInstanceRecord]] = None
    primary: Optional[RegistryInstanceRecord] = None
    __properties: ClassVar[List[str]] = ["service_name", "instances", "primary"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "instances": [RegistryInstanceRecord.from_dict(_item) for _item in obj.get("instances")] if obj.get("instances") is not None else None,
            "primary": RegistryInstanceRecord.from_dict(obj.get("primary")) if obj.get("primary") is not None else None
        })
        return _obj
