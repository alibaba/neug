...
class SchemaMappingLoadingConfigXCsrParams(BaseModel):
    """
    mutable_csr specific parameters
    """ # noqa: E501
    parallelism: Optional[StrictInt] = None
    build_csr_in_mem: Optional[StrictBool] = None
    use_mmap_vector: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["parallelism", "build_csr_in_mem", "use_mmap_vector"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "build_csr_in_mem": obj.get("build_csr_in_mem"),
            "use_mmap_vector": obj.get("use_mmap_vector")
        })
        return _obj
