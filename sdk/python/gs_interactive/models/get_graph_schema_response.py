...
class GetGraphSchemaResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "vertex_types": [GetVertexType.from_dict(_item) for _item in obj.get("vertex_types")] if obj.get("vertex_types") is not None else None,
            "edge_types": [GetEdgeType.from_dict(_item) for _item in obj.get("edge_types")] if obj.get("edge_types") is not None else None
        })
        return _obj
