...
class SchemaMappingLoadingConfig(BaseModel):
    ...
    """ # noqa: E501
    x_csr_params: Optional[SchemaMappingLoadingConfigXCsrParams] = None
    ...
    __properties: ClassVar[List[str]] = ["x_csr_params", "data_source", "import_option", "format", "destination"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "x_csr_params": SchemaMappingLoadingConfigXCsrParams.from_dict(obj.get("x_csr_params")) if obj.get("x_csr_params") is not None else None,
