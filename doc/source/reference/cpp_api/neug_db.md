...
- **Parameters:**
  ...
  - `max_num_threads`: Maximum threads for concurrent operations. If 0, uses hardware concurrency (number of CPU cores), falling back to 1 if the runtime cannot detect it
