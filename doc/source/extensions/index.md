...
| Vector Search   | [Vector Search](../storage_index/vector_search.md) | Vector distance functions and HNSW-based approximate nearest neighbor search | v0.2.0          |
| Search          | [Full-Text Search](../storage_index/fts_search.md) | BM25-ranked full-text search over string properties with SQLite FTS5 indexes | v0.2.0          |
