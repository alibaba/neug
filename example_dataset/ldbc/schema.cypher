...
create node table Person (id INT64, firstName STRING, lastName STRING, gender STRING, birthday INT64, creationDate INT64, locationIP STRING, browserUsed STRING, language STRING, email STRING, PRIMARY KEY (id));
...
create rel table Comment_hasCreator (FROM Comment TO Person, creationDate INT64, MANY_MANY);
...
create rel table Post_hasCreator (FROM Post TO Person, creationDate INT64, MANY_ONE);
